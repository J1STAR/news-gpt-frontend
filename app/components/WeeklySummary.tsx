        ...
        {keywords.map(kw => {
          ...
          return (
            <button
              key={kw.keyword}
              title={kw.reason}
              className={`flex-shrink-0 cursor-pointer rounded-full border border-gray-600 px-3.5 py-2 text-sm font-medium shadow-lg transition-all duration-300 ease-in-out hover:-translate-y-0.5 hover:shadow-blue-500/50 ${
                isActive
