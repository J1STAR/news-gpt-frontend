...
export default function Chatbot() {
    ...
    return (
        <div className="sticky top-0 my-8 rounded-lg bg-[var(--card-light)] p-6 shadow-md dark:bg-[var(--card-dark)]">
            <h2 className="mb-5 inline-block border-b-4 border-[var(--accent-color)] pb-2 text-2xl font-bold">💬 AI 뉴스 분석 챗봇</h2>
